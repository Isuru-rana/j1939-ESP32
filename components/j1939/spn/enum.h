...
enum class spns
{
    ...
    joystick1_x_axis_lever_right_positive_position_status = 2665,   // [13]
    joystick1_y_axis_lever_forward_positive_position_status = 2666,   // [13]
    joystick1_theta_axis_clockwise_positive_position_status = 2669, // [13]
    joystick1_x_lever_left_neg_pos_status = 2670,   // [7]
    joystick1_x_axis_lever_left_negative_position_status = 2670,    // [13]
    joystick1_y_axis_lever_back_negative_position_status = 2671,    // [13]
    ...
    text_display_instructions = 3613,               // [13]
    text_display_index = 3614,                      // [13]
    text_display_character = 3615,                  // [13]
